...
using Settings = WebApp.Strategy.Models.Settings;
...
builder.Services.AddScoped<IProductRepository>(sp =>
{
    ...
    var claim = httpContextAccessor.HttpContext.User.Claims.Where
    (x=>x.Type == Settings.claimDatabaseType).FirstOrDefault();
